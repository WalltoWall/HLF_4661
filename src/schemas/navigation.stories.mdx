...
- **Primary**: Used as the main navigation displayed in the site's header and
  footer.
- **Secondary**: Used as the smaller, less prominent navigation displayed in the
  site's header.
- **Footer**: Displayed in the footer next to the site's copyright.

Do not delete these documents. Adding new Navigation documents will not affect
the site and is not recommended. You can, however, edit those three documents as
needed.
