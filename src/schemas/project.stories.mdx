...
The Project custom type represents an Omidyar Fellows project. Projects are
managed in Prismic using two tabs: Main and Body.
...
that appear in the sidebar for project pages can be edited from the **Projects**
page.
