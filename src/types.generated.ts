...
export enum PrismicPageBodyHeroImageFieldsEnum {
  SliceType = 'slice_type',
  SliceLabel = 'slice_label',
  PrimaryVariant = 'primary___variant',
  PrimaryTextHtml = 'primary___text___html',
  PrimaryTextText = 'primary___text___text',
  PrimaryTextRaw = 'primary___text___raw',
  PrimaryButtonTextHtml = 'primary___button_text___html',
...
export type PrismicPageBodySlicesType = PrismicPageBodyText | PrismicPageBodyAnchor | PrismicPageBodyHeroImage | PrismicPageBodyHeroImageCarousel | PrismicPageBodyQuoteSlideshow | PrismicPageBodyLearningExcursionMap | PrismicPageBodyFellowsGrid | PrismicPageBodyImageCarousel | PrismicPageBodyLinkCollection | PrismicPageBodyHeadshotQuote | PrismicPageBodyCallsToAction;
...
export type PageBodyHeroImageFragment = { primary?: Maybe<(
    Pick<PrismicPageBodyHeroImagePrimaryType, 'variant'>
    & { text?: Maybe<Pick<PrismicStructuredTextType, 'text' | 'html'>>, button_text?: Maybe<Pick<PrismicStructuredTextType, 'text'>>, button_link?: Maybe<Pick<PrismicLinkType, 'url'>>, background_image?: Maybe<(
      Pick<PrismicImageType, 'alt'>
      & { fluid?: Maybe<GatsbyPrismicImageFluidFragment> }
    )> }
  )> };
