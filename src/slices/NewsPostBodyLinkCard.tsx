...
import { NewsPostBodyLinkCardFragment } from '../types.generated'
...
export type NewsPostBodyLinkCardProps = ReturnType<typeof mapDataToProps> &
  PageTemplateEnhancerProps

export const NewsPostBodyLinkCard = ({
  title,
  href,
  nextSharesBg,
  id,
}: NewsPostBodyLinkCardProps) => {
...
export const fragment = graphql`
  fragment NewsPostBodyLinkCard on PrismicNewsPostBodyLinkCard {
    primary {
      link_title {
        text
      }
